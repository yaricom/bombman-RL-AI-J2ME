...
public interface GameConfig
{
  ...
  /** Screen height */
  public static final int screenHeight = 65;
  ...
  public static final int loadProgressBarX = 3;
  /** The Y coordinate of top left corner for progress bar drawing */
  public static final int loadProgressBarY = 60;
  /** Load progress bar width */
  public static final int loadProgressBarW = 90;
  /** Load progress bar height */
  public static final int loadProgressBarH = 3;
  /** Progress bar color */
  public static final int progressBarColor = 0xFFFFFF;

  /** Vertical offset for 'press any key' caption */
  public static final int pressAnyKeyOffset = 63;
  ...
  public static final int menuTitleLeftX = 10;

  /** Main menu first option left X coordinate */
  public static final int mainMenuOptionX = 14;
  /** Main menu first option top Y coordinate */
  public static final int mainMenuOptionY = 16;
  /** Main menu highlighted option height */
  public static final int mainMenuOptionHeight = 14;
  /** Main menu interoption distance */
  public static final int mainMenuInterval = 0;

  /** Number of menu options to draw simultaneously */
  public static final int mainMenuOptionDrawCount = 3;

  /** Main menu decor cross left X */
  public static final int mainMenuCrossX = 0;
  /** Main menu decor cross top Y */
  public static final int mainMenuCrossY = 0;
  /** Main menu decor cross index */
  public static final int mainMenuCrossIndex = 1;
  /** Horizontal segments count */
  public static final int mainMenuFlameHorizCount = 0;
  /** Vertical segments count */
  public static final int mainMenuFlameVertCount = 0;

  /** Main menu pointer left X coordinate */
  public static final int mainMenuPointerX = 1;
  /** ain menu pointer area height */
  public static final int mainMenuPointerAreaHeight = mainMenuOptionHeight * 3 +
      mainMenuInterval * 2;

  /** Main menu area width */
  public static final int mainMenuAreaWidth = 94;
  /** Main menu area height */
  public static final int mainMenuAreaHeight = 46;
  /** Main menu area left X coordinate */
  public static final int mainMenuAreaX = 1;
  /** Main menu area top Y coordinate */
  public static final int mainMenuAreaY = 14;
  ...
  public static final int mainMenuTextAreaY = mainMenuAreaY + 5;
  ...
  public static final int mainMenuTextLinesCount = 4;
  ...
  public static final int settMenuOptionHeight = 14;
  /** Settings menu interoption distance */
  public static final int settMenuInterval = 0;
  /** Setting menu icon left coordinate */
  public static final int settMenuIconX = settMenuOptionX + 1;
  /** Setting menu icon top offset */
  public static final int settMenuIconYOffset = 1;
  /** Settings menu checkbox right X coordinate */
  public static final int settMenuCheckboxX = settMenuOptionX +
      settMenuOptionWidth - 4;
  ...
  public static final int settMenuTextX = settMenuOptionX + 15;
  /** Settings menu text top offset */
  public static final int settMenuTextYOffset = 2;
  ...
  public static final int gameMenuTitleX = 10;
  /** Title top Y coordinate */
  public static final int gameMenuTitleY = 0;
  /** Game menu area left X coordinate */
  public static final int gameMenuAreaX = mainMenuAreaX;
  /** Game menu area top Y coordinate */
  public static final int gameMenuAreaY = mainMenuAreaY;
  /** Game menu area width */
  public static final int gameMenuAreaWidth = mainMenuAreaWidth;
  /** Game menu area height */
  public static final int gameMenuAreaHeight = mainMenuAreaHeight;
  /** Text padding */
  ...
  public static final int gameMenuTextLines = mainMenuTextLinesCount;
  /** Load bar left X coordinate */
  public static final int gameMenuLoadBarX = gameMenuAreaX + 5;
  /** Load bar width */
  public static final int gameMenuLoadBarWidth = gameMenuAreaWidth - 10;
  /** Load bar width */
  public static final int gameMenuLoadBarHeight = 3;
  ...
  public static final int gameMenuScrollBarHeight = gameMenuAreaHeight - 4;
  /** Top Y coordinate for game menu scroll bar drawing */
  public static final int gameMenuScrollBarY = gameMenuAreaY + 2;
  /** Center X coordinate for scroll marks drawing in game menu area */
  public static final int gameMenuScrollMarkX = gameMenuAreaX + gameMenuAreaWidth - 5;


  /** The height of level box */
  public static final int gameMenuLevelBoxHeight = 14;
  ...
  public static final int gameMenuLevelBoxTextYOffset = 2;
  ...
  //
  /** Bottom area height */
  public static final int gameScreenIndicatorsAreaHeight = 12;
  ...
  public static final int gameScreenIndicatorY = gameScreenActiveHeight + 1;
  ...
  public static final int gameScreenPauseMenuWidth = 96;
  /** The height of pause menu area */
  public static final int gameScreenPauseMenuHeight = gameScreenActiveHeight - 4;
  ...
  public static final int gameScreenPauseMenuOptionY = gameScreenPauseMenuY + 4;
  /** The pause menu interoption distance */
  public static final int gameScreenPauseMenuInterval = 2;
  /** The pointer horizontal offset regarding option */
  public static final int gameScreenPauseMenuPointerXOffset = 1;
  ...
  public static final int levelFadingSegments = 5;
  ...
  public static final int FONT_TEXT_HEIGHT = -1;

  public static final int FONT_MENU_STYLE = Font.STYLE_BOLD;
  public static final int FONT_MENU_SIZE = Font.SIZE_SMALL;
  public static final int FONT_MENU_HEIGHT = -1;
  ...
  //
  /** Command height */
  public static final int commandHeight = 5;
  ...
  public static final int commandPositiveX = 3;
  /** Right X coordinate for negative command drawing */
  public static final int commandNegativeX = screenWidth - 3;
}