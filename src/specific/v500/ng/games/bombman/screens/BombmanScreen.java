...
public class BombmanScreen extends Canvas
{
  ...
  protected void keyPressed( int keyCode )
  {
    ...
    if( this.game.gameState != BombmanGame.STATE_SHOW_SPLASH ){
      // compare with positive and negative values to avoid issues with old and new V series
      if( keyCode == KEY_SOFTKEY2 || keyCode == -KEY_SOFTKEY2 )
        this.fireCommandAction( this.positiveCommand );
      else if( keyCode == KEY_SOFTKEY1 || keyCode == -KEY_SOFTKEY1 )
