...
public interface GameConfig
{
  ...
  /** Screen height */
  public static final int screenHeight = 204;
  ...
  public static final int settMenuTextYOffset = 0;
  ...
  public static final int gameScreenPauseMenuOptionY = gameScreenPauseMenuY + 14;
  /** The pause menu interoption distance */
  public static final int gameScreenPauseMenuInterval = 7;
  ...
  public static final int commandPositiveX = screenWidth;
  /** Right X coordinate for negative command drawing */
  public static final int commandNegativeX = 0;
}